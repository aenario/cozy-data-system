...
var checkDocType, child, count, db, feed, fork, fs, log;
...
module.exports.incrementCount = function(req, next) {
  var waitReindexing, _ref;
  count += 1;
  waitReindexing = !!((_ref = req.query) != null ? _ref.waitReindexing : void 0);
  if (count > 100 && !child) {
